...
![Language](https://img.shields.io/badge/Language-HTML/CSS/JS-orange.svg)
![Platform](https://img.shields.io/badge/Platform-Web-green.svg)

## 🚀 Live Demo
**https://green-88.github.io/TYPEMASTER/**

## ✨ Features

### 1. 📈 Multi-Level Learning
*   **Basic (वर्णमाला):** Practice Hindi vowels and consonants.
*   **Intermediate (वाक्य):** Improve flow with common sentences.
...
*   **CSS3:** Custom properties (variables), Flexbox, and Grid for a responsive layout.
*   **Vanilla JavaScript:** Logic for timer, WPM calculation, and history management. **(No frameworks required!)**

## 📂 Project Structure
```text
├── index.html   # Contains all HTML
├── style.css    # Contains all CSS
├── script.js    # Contains all JS logic
...
---
**Created with ❤️ for the Hindi Typing Community.**
